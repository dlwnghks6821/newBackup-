...
<body>
	...
	<nav class="nav-bar">
		...
		<div class="nav-menu">
			...
			<div class="nav-items2"><a class="nav-i"href="">게시판</a> </div>
  ...
  <input type="text" class="form-control" name="userid" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
  	...
  	<div class="notice"><p class="notice-items"> <a class="noticeA" href="">공지사항!</a></p> </div>
...
<div class="input-group mb-3">
 ...
 <table class="table table-striped" >
   ...
   <button type="button" class="btn btn-primary"><a href="http://localhost:8080/project/board_new">글작성하기</a></button>
         <button type="button" class="btn btn-info"><a href="http://localhost:8080/project/board?pageNum=1"class="return-items">되돌아가기</a></button>
